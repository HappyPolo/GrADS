...
'enable print F:\scripts\grads\week9.2.16303003.gmf'
'set gxout shaded'
'set x 1'
'set y 1'
'set t 1 146'
...
'set lat -90 90'
'colormap temp_19lev'
'define nino34ann=ave(aave(sstwin,lon=-170,lon=-120,lat=-5,lat=5),t=111,t=147,1)'
...
'set lat -90 90'
'set t 111'
'define coejja = tregr(ninoano,sstsum,time=mar1980,time=mar2017)'
'define coeson = tregr(ninoano,sstaut,time=mar1980,time=mar2017)'
'define coedjf = tregr(ninoano,sstwin,time=mar1980,time=mar2017)'
